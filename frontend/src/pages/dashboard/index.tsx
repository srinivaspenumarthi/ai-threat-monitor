    ...
    <div className={styles.page}>
      <section className={styles.hero}>
        <div>
          ...
          <h2 className={styles.heroTitle}>Threat pulse across recent traffic</h2>
          <p className={styles.heroText}>
            Watch live detections, inspect severity balance, and spot the
            busiest attack paths before they turn into incidents.
          </p>
        </div>

        <div className={styles.heroBadge}>
          <span className={styles.heroBadgeLabel}>Current mode</span>
          <strong>{modelStatus?.detection_mode ?? 'Starting'}</strong>
        </div>
      </section>
      ...
      <div className={styles.severitySection}>
        <div className={styles.sectionHeader}>
          <div>
            <span className={styles.sectionEyebrow}>Severity mix</span>
            <h3 className={styles.sectionTitle}>How risky the incoming activity looks</h3>
          </div>
        </div>
