  ...
  return (
    <div className={styles.page}>
      <section className={styles.hero}>
        <div>
          <span className={styles.eyebrow}>Investigation</span>
          <h2 className={styles.heroTitle}>Search, sort, and open suspicious events</h2>
          <p className={styles.heroText}>
            Narrow the stream by severity or source IP, then open any row to
            inspect request details and model scores.
          </p>
        </div>
      </section>
      ...
      <div className={styles.filterCard}>
        <div className={styles.filterHeader}>
          <div>
            ...
            <h3 className={styles.filterTitle}>Refine the threat list</h3>
          </div>
        </div>
