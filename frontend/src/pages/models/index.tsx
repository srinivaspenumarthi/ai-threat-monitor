    ...
    <div className={styles.page}>
      <section className={styles.hero}>
        <div>
          ...
          <h2 className={styles.heroTitle}>Detection engines behind the alerts</h2>
          <p className={styles.heroText}>
            Check which models are active, see their metrics, and retrain when
            fresh traffic patterns should shape the detector again.
          </p>
        </div>
      </section>
