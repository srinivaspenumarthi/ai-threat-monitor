...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    logger.info("Threat Monitor started — pipeline active")
    ...
    logger.info("Threat Monitor shut down cleanly")
...
def create_app() -> FastAPI:
    """
    Build and configure the Threat Monitor FastAPI application.
    """
    app = FastAPI(
